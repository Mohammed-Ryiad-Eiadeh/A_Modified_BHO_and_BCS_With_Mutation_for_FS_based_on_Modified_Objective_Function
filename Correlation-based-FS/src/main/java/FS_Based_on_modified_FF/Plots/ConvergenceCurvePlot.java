...
public class ConvergenceCurvePlot {
     ...
     */
    public ConvergenceCurvePlot(String name, HashMap<String, Double[]> firstVectorFS, HashMap<String, Double[]> secondVectorFS, HashMap<String, Double[]> firstVectorFSCorrelation, HashMap<String, Double[]> secondVectorFSCorrelation) {

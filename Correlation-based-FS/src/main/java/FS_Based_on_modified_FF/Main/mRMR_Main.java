...
import org.tribuo.classification.fs.mRMR;
...
public class mRMR_Main {
    public static void main(String[] args) throws IOException {
        ...
        var MIM_Filter = new mRMR(13, 5, Runtime.getRuntime().availableProcessors());
        var sDate = System.currentTimeMillis();
        var SFS = MIM_Filter.select(dataSet);
